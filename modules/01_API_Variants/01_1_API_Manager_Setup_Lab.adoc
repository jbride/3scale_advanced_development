...
$  git clone https://github.com/gpe-mw-training/3scale_development_labs.git $HOME/lab/3scale_development_labs.git
-----
...
echo "export OCP_AMP_ADMIN_ID=api0                                                      #   Name of API Manager administrator " >> ~/.bashrc
