...
It is possible for these SOAP requests to be sent to 3scale's APIcast gateway, forwarded to your back-end SOAP services, and reported on to the 3scale API Manager without any customizations.
