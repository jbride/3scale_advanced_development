...
+
Would could be an alternative approach to the 3scale SOAP _policy_ if the requirement is to track invocations of specific SOAP operations but the SOAP clients can not be modified to add the _SOAPAction_ HTTP header ?
