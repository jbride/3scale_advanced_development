...
The javascript that retrieves and renders the list of discovered APIs is broken.
Subsequently, if using Chrome you will not see the list of APIs.
As a work-around, please use the Firefox browser.
