...
An alternative to customizing policies that get executed by your APIcast gateways for gathering of metrics based on the SOAP operations of a SOAP service is to use JBoss Fuse.

JBoss Fuse can serve as a mediation layer between the data plane of your API Management deployment and your backend SOAP services. 
