...
At this point in the lab, you have been able to successfully invoke your backend SOAP 1.1 service via the APIcast gateway proxy.
...
. Using either the _curl_ utility or SOAP-UI, make several invocations to each of the four SOAP operations of the _Stores_API.
