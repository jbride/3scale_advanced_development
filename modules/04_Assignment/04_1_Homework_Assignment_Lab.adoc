...
Notice that the Swagger spec is provided for both APIs. 

You can use the Swagger editor (http://editor.swagger.io/) to explore the methods & mappings available to be set up for the APIs in 3scale.
