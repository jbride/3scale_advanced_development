...
HTML _sections_ are a grouping of content and should appear as an entry in an outline of an HTML page.
...
It's this latter capability of *Sections* that facilitates the _Group Membership Signup Flow_.
